...
PROTOBUF_CONSTEXPR Company::Company(
  ...
  , /*decltype(_impl_.foundingyear_)*/0
...
class Company::_Internal {
 public:
  ...
  static void set_has_foundingyear(HasBits* has_bits) {
    (*has_bits)[0] |= 8u;
  }
...
Company::Company(const Company& from)
  ...
  ::memcpy(&_impl_.foundingyear_, &from._impl_.foundingyear_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.foreigneconomicactivity_) -
    reinterpret_cast<char*>(&_impl_.foundingyear_)) + sizeof(_impl_.foreigneconomicactivity_));
...
// @@protoc_insertion_point(message_clear_start:Company)
  ...
  if (cached_has_bits & 0x00000018u) {
    ::memset(&_impl_.foundingyear_, 0, static_cast<size_t>(
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 8)) {
          _Internal::set_has_foundingyear(&has_bits);
          _impl_.foundingyear_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* Company::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000008u) {
    ...
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(1, this->_internal_foundingyear(), target);
  }
...
// @@protoc_insertion_point(required_fields_byte_size_fallback_start:Company)
  ...
  if (_internal_has_foundingyear()) {
    // required int32 foundingYear = 1;
    total_size += ::_pbi::WireFormatLite::Int32SizePlusOne(this->_internal_foundingyear());
  }
...
void Company::InternalSwap(Company* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      ...
      - PROTOBUF_FIELD_OFFSET(Company, _impl_.foundingyear_)>(
          reinterpret_cast<char*>(&_impl_.foundingyear_),
          reinterpret_cast<char*>(&other->_impl_.foundingyear_));
}
